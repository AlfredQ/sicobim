...
switch ($opc)
{
	...
	case 1:
	    ...
	    $ciusu = $ci;
			  if ($radio== C)
			  {
			  	 $asignacion->insertarCompra($fechaF, $fechaO, $fechaRegistro, $ciusu);
			  
			  }
			  else
			  {
			  
			  $asignacion->insertarJustiprecio($fechaRegistro, $ciusu);
			  }
	   ...
	   // $asignacion->insertarCompra($fechaF, $fechaO, $fechaRegistro, $ciusu);
	    ...
	    { 
	       ...
	       $acta;
		   $actaj; 
	     $asignacion->insertar($acta, $numBien, $numSubg, $numSecc, $numProd, $bsf, $carac, $ciusu, $actaj );
