...
public function ConsultarDependencia( $intOpcion )
{
	...
	$arrResultado = $this->db->EjecutarQuery("SELECT * FROM sch_sicobim.vista_dependencias");
...
{ 
	$arrResultado = $this->db->EjecutarQuery("SELECT * FROM sch_sicobim.vista_direcciones");
...
public function ConsultarUnidad( $intOpcion )
{
	...
	$arrResultado = $this->db->EjecutarQuery("SELECT * FROM sch_sicobim.vista_unidades");
...
{ echo  "fn_m_producto(".$this->getId_Prod().",
								'".$this->getNombreProd()."' ,
								'".$this->getDescripcionProd()."' ,
								".$this->getCodigoSubGrupo().",
								".$this->getCodigoSeccion().")";
