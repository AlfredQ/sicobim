				 ...
				 $("#menuRegistrarCoordinacion").click(function()
					{
					 ...
					 /********************************************************
					  * MENU - CONSULTAR ASIGNACION DE CONTROL DE INVENTARIO *
					  ********************************************************/
					 $("#menuConsultarAsignacionInventario").click(function()
							 {
						 $("div#error").cerrar();
						 $.ajax
						 ({		 
							 type: "POST",
							 url: "../controlador/asignacion/asignacionControl.php?opc=2",
							 dataType:"json",
							 data:"",
							 async:true,
							 success: function(data)
