...
this.aanFeatures=[];this.oLanguage={sProcessing:"Procesando...",sLengthMenu:"Mostrar _MENU_ Solicitudes por pagina",sZeroRecords:"No hay registros coincidentes",sInfo:"Mostrando _START_ al _END_ de _TOTAL_ Registros",sInfoEmpty:"Mostrando 0 al 0 de 0 registros",sInfoFiltered:"(filtrado de _MAX_  registros)",sInfoPostFix:"",sSearch:"Filtrar Solicitud:",sUrl:"",oPaginate:{sFirst:"Principio",sPrevious:"Anterior",sNext:"Siguiente",sLast:"Ultimo"}};
...
nFilter.innerHTML=oSettings.oLanguage.sSearch+sSpace+'<input id="campo_filtrar" name="campo_filtrar"  type="text" />';var jqFilter=$("input",nFilter);
...
var sStdMenu='<select size="1" '+sName+'><option value="10">10</option><option value="20">20</option><option value="50">50</option><option value="100">100</option></select>';
